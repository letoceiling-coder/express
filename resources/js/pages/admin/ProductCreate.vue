<template>
    <div class="product-create-page">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-foreground">Создать товар</h1>
            <p class="text-muted-foreground mt-1">Добавление нового товара</p>
        </div>
...
export default {
    ...
    methods: {
        ...
        async handleSubmit() {
            ...
            try {
                ...
                if (errorData.errors) {
                    ...
                    await swal.error(error.message || 'Ошибка создания товара');
                }
            } finally {
                this.loading = false;
            }
        ...
        handleGallerySelected(media) {
            // media может быть массивом (multiple) или объектом (single)
