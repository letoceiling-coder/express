...
class AboutPageController extends Controller
{
    ...
    public function show(): JsonResponse
    {
        ...
        return response()->json([
            'data' => [
                ...
                'support_enabled' => $page->support_enabled ?? true,
                'support_label' => $page->support_label ?? 'Написать в поддержку',
    ...
    public function update(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'support_enabled.boolean' => 'Поле "Включено" должно быть булевым значением',
            'support_label.string' => 'Текст кнопки должен быть строкой',
            'support_label.max' => 'Текст кнопки не должен превышать 100 символов',
