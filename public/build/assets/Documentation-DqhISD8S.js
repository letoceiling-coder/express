                ...
                <pre><code>POST /api/v1/roles
{
    ...
    "description": "Менеджер контента"
            ...
            `},getAdminBotUsersContent(){return`
                ...
                <p>Пользователи бота могут подавать заявки на получение ролей <strong>courier</strong> (курьер) или <strong>admin</strong> (администратор) через команды бота.</p>
