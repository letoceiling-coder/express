...
/&gt;</code></pre>
    ...
    "image": {
        ...
        "variants": {
            ...
            `}}},u={class:"documentation-page"},h={class:"flex gap-6"},v={class:"w-64 flex-shrink-0"},_={class:"bg-card rounded-lg border border-border p-4 sticky top-6 max-h-[calc(100vh-3rem)] overflow-y-auto"},x={class:"space-y-1"},b=["onClick"],T={key:1},y={class:"px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider"},P={class:"ml-2 mt-1 space-y-1"},S=["onClick"],E={class:"flex-1 min-w-0"},O={class:"bg-card rounded-lg border border-border p-8"},w=["innerHTML"];function f(k,c,A,C,t,r){return l(),o("div",u,[c[0]||(c[0]=e("div",{class:"mb-6"},[e("h1",{class:"text-2xl font-bold text-foreground"},"Документация"),e("p",{class:"text-muted-foreground mt-1"},"Полная техническая документация системы управления")],-1)),e("div",h,[e("aside",v,[e("div",_,[e("nav",x,[(l(!0),o(n,null,s(t.sections,i=>(l(),o(n,{key:i.id},[!i.children||i.children.length===0?(l(),o("button",{key:0,onClick:d=>{t.activeSection=i.id,r.scrollToTop()},class:p(["w-full text-left px-3 py-2 rounded-lg text-sm font-medium transition-colors",t.activeSection===i.id?"bg-primary text-primary-foreground":"text-muted-foreground hover:bg-muted hover:text-foreground"])},a(i.title),11,b)):(l(),o("div",T,[e("div",y,a(i.title.replace(/^[^\s]+\s/,"")),1),e("div",P,[(l(!0),o(n,null,s(i.children,d=>(l(),o("button",{key:d.id,onClick:D=>{t.activeSection=d.id,r.scrollToTop()},class:p(["w-full text-left px-3 py-1.5 rounded text-xs transition-colors",t.activeSection===d.id?"bg-primary/20 text-primary font-medium":"text-muted-foreground hover:bg-muted/50"])},a(d.title),11,S))),128))])]))],64))),128))])])]),e("main",E,[e("div",O,[e("div",{innerHTML:r.currentContent,class:"prose prose-sm max-w-none dark:prose-invert documentation-content"},null,8,w)])])])])}const G=g(m,[["render",f],["__scopeId","data-v-9446983f"]]);export{G as default};
